...
namespace bitrpc
{
    namespace client
    {
        ...
        public:
            ...
            // 创建主题
            bool create(const BaseConnection::ptr &conn, const std::string &key) // key:主题名称
            {
            ...
            // 订阅主题
            bool subscribe(const BaseConnection::ptr &conn, const std::string &key, const SubCallback &cb) // 收到订阅主题消息后消息处理回调函数
            {
                addSubscribe(key, cb);
